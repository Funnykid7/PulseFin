...
* **AI Efficiency (Tagging & Caching):** To minimize AI API costs, implement a "Tagging & Caching" strategy. Individual songs must be analyzed once for "mood/vibe" and cached in the Supabase database. Recommendations should be generated by matching "Recently Played" tags against the cached library tags to avoid repeated full-library analysis.
